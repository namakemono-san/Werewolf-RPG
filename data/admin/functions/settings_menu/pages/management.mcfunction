...
item modify entity @s enderchest.10 admin:click/click_get
...
item modify entity @s enderchest.11 admin:click/click_get
...
item modify entity @s enderchest.13 admin:click/click_get
...
item modify entity @s enderchest.14 admin:click/click_get
...
item modify entity @s enderchest.15 admin:click/click_get
...
item modify entity @s enderchest.16 admin:click/click_get