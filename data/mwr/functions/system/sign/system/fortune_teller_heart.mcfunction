...
## 占い結果表示
    ...
    execute if entity @s[team=Vampire] run title @a[tag=clicked] title {"text":"吸血鬼","color": "light_purple","bold":true}
    execute if entity @s[team=Vampire] run tellraw @a[tag=clicked] [{"text": "[","color":"red","bold":true},{"text":"人狼ＲＰＧ","color":"red","bold":false},{"text":"] ","color":"red","bold":true},{"selector":"@s","color": "white","bold":false},{"text":"：","color": "white","bold":true},{"text":"吸血鬼","color": "light_purple","bold":true}]
