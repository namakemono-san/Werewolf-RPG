...
## 吸血鬼
    execute as @a[team=Vampire] run title @s title {"text":"吸血鬼","color":"light_purple","bold":true}
    execute as @a[team=Vampire] run tellraw @s ["",{"text": "[","color":"red","italic":false,"bold":true},{"text":"人狼ＲＰＧ","color":"red","italic":false},{"text":"] ","color":"red","italic":false,"bold":true},{"text": "あなたの役職："},{"text": "吸血鬼","color":"light_purple","bold":true}]
